...
from rpmeta.model import save_model
...
class BaseModel(Model):
    ...
    def create_pipeline(self, params: dict[str, int | float | str]) -> Any:
    ...
    @classmethod
    def get_registry(cls) -> list[Model]:
        result = []
        ...
        for t in study.trials:
            trial_results.append(
                TrialResult(
                    ...
                    test_score=-t.value,
                    fit_time=t.user_attrs.get("fit_time", 0),
                ),
            )
    ...
    def run(
        ...
        model_path = f"{result_dir}/{self.name}_{now}.joblib"
